    ...
    <section className="bg-white py-24 px-6 relative overflow-hidden">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          <span className="inline-block py-1 px-3 rounded-full bg-accent/10 text-accent text-[10px] font-black uppercase tracking-widest mb-4">
            {badge}
          </span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          {standardPacks.map((pack) => (
            <div
              key={pack.id}
              className="group relative bg-[#F9F9F9] rounded-[2rem] overflow-hidden border border-black/5 flex flex-col sm:flex-row transition-all hover:shadow-2xl hover:shadow-black/5"
            >
              ...
              <div className="sm:w-2/5 h-64 sm:h-auto relative overflow-hidden bg-gray-200">
                ...
                />
                <div className="absolute top-4 left-4 z-10 bg-accent text-black font-black px-3 py-1 rounded-lg text-sm shadow-xl transform group-hover:rotate-3 transition-transform">
                  {currency} {pack.price}
                </div>
              ...
              <div className="p-8 sm:w-3/5 flex flex-col justify-center relative">
                ...
                <div className="bg-white p-4 rounded-2xl border border-black/5 shadow-sm group-hover:border-accent/30 transition-colors relative overflow-hidden">
                  <div className="flex items-center gap-2 text-accent font-black text-[9px] uppercase tracking-[0.2em] mb-1">
                    <Gift size={12} />
                    {plusFreeLabel}
                  </div>
        ...
        {familyPack && (
          <div className="relative bg-black rounded-[3rem] overflow-hidden group min-h-[550px] flex items-center">
            <div className="absolute inset-0 z-0">
              <Image
                ...
                /* 
                   Featured pack is almost full screen width on mobile 
                   and full container width (max-w-7xl) on desktop.
                */
            ...
            <div className="relative z-10 max-w-3xl p-8 md:p-20">
              <div className="flex items-center gap-3 mb-8">
                <span className="bg-accent text-black text-[10px] font-black px-4 py-1.5 rounded-full uppercase tracking-tighter animate-pulse">
                  {bestSellerLabel}
                </span>
              ...
              <div className="inline-flex items-center gap-6 bg-white/10 backdrop-blur-2xl border border-white/20 p-6 pr-10 rounded-[2rem] group-hover:bg-white/20 transition-all group-hover:translate-x-2">
                <div className="w-16 h-16 rounded-2xl bg-accent flex items-center justify-center text-black shadow-2xl shadow-accent/40 rotate-3 group-hover:rotate-0 transition-transform">
            ...
            <div className="absolute right-[-5%] bottom-[-5%] text-white/[0.05] group-hover:text-accent/[0.05] transition-colors pointer-events-none">
