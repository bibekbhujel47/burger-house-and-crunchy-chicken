      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-on-surface-variant text-lg leading-relaxed mb-10 whitespace-pre-line">
              {description}
            </p>
          ...
          >
            ...
            >
              ...
              <span className="block text-[10px] uppercase font-bold tracking-[0.2em] text-white/60">
                {experienceLabel}
              </span>
            </motion.div>
          </motion.div>
